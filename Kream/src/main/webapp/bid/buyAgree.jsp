...
<link rel = "stylesheet" href = "/Kream/css/buyagree.css">
      ...
      <div class="allbig">
           <div class="bigtitle"> 
                ...
                <h2 data-v-3b9b7196="" class="check_title">
                 <span data-v-3b9b7196="" class="accent_text">구매</span>하시기 전에 
...
<div class="bigbottom">
          ...
          <li data-v-5e593dfe="" class="check_item">
              <a data-v-5e593dfe="" href="#" class="check_area">
                 <div data-v-5e593dfe="" class="notice_group">
                   <p data-v-5e593dfe="" class="notice_maintext">구매하려는 상품이 맞습니다.</p>
  ...
  <input type="checkbox" class="ckBox">
          ...
          <a data-v-5e593dfe="" href="#" class="check_area">
                 <div data-v-5e593dfe="" class="notice_group">
                      <p data-v-5e593dfe="" class="notice_maintext">국내/해외에서 발매한 정품 · 새상품입니다.</p>
                             <p data-v-5e593dfe="" class="notice_subtext">모든 구성품이 그대로이며, 한 번도 착용하지 않은 정품・새상품입니다. 국내 발매 상품 여부는 확인드리지 않습니다</p>
                </div>
               <div data-v-4c714e9f="" data-v-5e593dfe="" class="checkbox_item">
                  <input type="checkbox" class="ckBox">
                         <label data-v-4c714e9f="" for="undefined" class="check_label">
      ...
      <li data-v-5e593dfe="" class="check_item">
          <a data-v-5e593dfe="" href="#" class="check_area">
                 <div data-v-5e593dfe="" class="notice_group">
                      <p data-v-5e593dfe="" class="notice_maintext">제조사에서 불량으로 인정하지 않는 기준은 하자로 판단하지 않습니다.</p>
                             <p data-v-5e593dfe="" class="notice_subtext">박스/패키지와 상품컨디션에 민감하시다면 검수 기준을 반드시 확인하시기 바랍니다.</p>
                </div>
               <div data-v-4c714e9f="" data-v-5e593dfe="" class="checkbox_item">
                  <input type="checkbox" class="ckBox">
                         <label data-v-4c714e9f="" for="undefined" class="check_label">
...
<li data-v-5e593dfe="" class="check_item">
      <a data-v-5e593dfe="" href="#" class="check_area">
            <div data-v-5e593dfe="" class="notice_group">
                 <p data-v-5e593dfe="" class="notice_maintext">KREAM의 최신 이용정책을 모두 확인하였으며, 구매를 계속합니다.</p>
...
<br>
<a href = "/Kream/buyLastController.do?size_name=<%=size_name %>&bid_price=<%=bid_price %>&prodid=<%=prodid %>&size_id=<%=size_id %> " class = "btn_division sell">구매계속</a>
